...
Q.Sprite.extend("Wario", {
        init: function(p){
            this._super(p, {
                ...
                points: [[-9,-15],[9,-15],[9,16],[-9,16]] //Representa la colision (X defecto lo pone en 20 ya que el centro es "20")
        ...
        step: function(dt) {
            if(this.p.agachado){
                this.p.speed = 100;
                this.p.points = [[-5,-1],[5,-1],[5,16],[-5,16]]; //Cambiamos la colisión. (Representa un poligono formado respecto al centro del sprite)
                ...
                this.p.speed = 180;
                this.p.points = [[-9,-15],[9,-15],[9,16],[-9,16]];
            }
            ...
            if (Q.inputs["down"] && !this.p.vy>0){ //Está agachado
